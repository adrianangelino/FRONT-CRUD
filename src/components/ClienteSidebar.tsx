...
const navItems: NavItem[] = [
  ...
  { path: '/cliente/eventos', label: 'Eventos', icon: Calendar },
]
  ...
  return (
    <>
      ...
      <button
        ...
        className="lg:hidden fixed top-4 left-4 z-50 p-2 bg-gray-800 rounded-md text-gray-300 hover:bg-gray-700 border border-gray-700 shadow-lg"
          ...
          <div className="p-6 border-b border-gray-700">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-gray-400 text-xs">TICKETS & EVENTS</p>
              </div>
            </div>
          </div>
